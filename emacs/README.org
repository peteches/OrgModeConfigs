...
** GPG
So I don't use GPG all that much, I probably should though.
SO here's me trying again, as this should allow me to start using some cool encryption features with Emacs.
#+begin_src emacs-lisp
...
*** Mac Support
Following the [[https://github.com/Homebrew/homebrew-core/issues/14737][Github Issue]] We need to use a different pinentry program specifically for macs:
