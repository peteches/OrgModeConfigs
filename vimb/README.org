...
#+begin_src conf
set download-command=/bin/sh -c 'curl --create-dirs --fail --globoff --location --no-clobber --output-dir '${VIMB_DOWNLOAD_PATH}' --proto "=ftps,https" --remote-name --remove-on-error --silent --speed-limit 5 --speed-time 10 %s'
#+end_src
