...
* Hyprland config
:PROPERTIES:
:header-args: :tangle ~/.config/hypr/hyprland.conf :mkdir yes
:END:
...
** Hyprlock
:PROPERTIES:
:header-args: :mkdirp yes :tangle ~/.config/hypr/hyprlock.conf
:END:
...
** Hypridle
:PROPERTIES:
:header-args: :mkdirp yes :tangle ~/.config/hypr/hypridle.conf
:END:
